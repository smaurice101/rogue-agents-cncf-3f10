[rogue-agents-cncf-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [rogue-agents-cncf-3f10] container is NOT running**.

.. tip::
   You must have your [rogue-agents-cncf-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   http://localhost:9689/rogueagents2.html?topic=iot-preprocess&offset=-1&groupid=&rollbackoffset=45&topictype=prediction&append=0&secure=1
...
.. important::
   Refer to the original solution container and documenation here: https://rogue-agents-cncf-3f10.readthedocs.io/en/latest/operating.html
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/rogue-agents-cncf-3f10-amd64
...
[rogue-agents-cncf-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/rogue-agents-cncf-3f10
...
.. important::
   solution_preprocessing_dag-rogue-agents-cncf-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=39389, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=38583, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=33153, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=35321, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=41851, HPDEHOST=172.17.0.2, HPDEPORT=36055, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=42717

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9173-rogue-agents-cncf-3f10,solution_preprocessing_dag-rogue-agents-cncf-3f10, python-preprocess-7246-rogue-agents-cncf-3f10,solution_preprocessing_dag-rogue-agents-cncf-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
